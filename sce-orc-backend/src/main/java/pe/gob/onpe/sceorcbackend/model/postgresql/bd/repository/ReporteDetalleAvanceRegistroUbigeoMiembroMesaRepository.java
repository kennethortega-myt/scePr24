...
public interface ReporteDetalleAvanceRegistroUbigeoMiembroMesaRepository extends JpaRepository<Usuario, Long> {
    ...
    @Query(value = """
        ...
        FROM fn_reporte_avance_registro_ubigeo_miembro_mesa(:esquema, :idAmbito, :idCentroComputo, :ubigeo)
        ORDER BY c_procesada DESC
        """,
            nativeQuery = true)
