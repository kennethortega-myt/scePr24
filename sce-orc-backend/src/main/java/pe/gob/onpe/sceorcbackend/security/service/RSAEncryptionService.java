...
public class RSAEncryptionService {
    ...
    private void generateKeyPair() {
        try {
            ...
            throw new InternalServerErrorException("Error generando claves RSA", e);
        }
    }
    ...
    public String getPublicKeyAsString() {
        try {
            ...
            throw new InternalServerErrorException("Error obteniendo clave pública", e);
        }
    }
    ...
    public String decryptPassword(String encryptedPassword) {
        try {
            ...
            throw new InternalServerErrorException("Error desencriptando contraseña", e);
        }
    }
}
