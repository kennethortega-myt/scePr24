...
public class BaseController {
    ...
    protected ResponseEntity<GenericResponse<String>> getPdfResponse(byte[] data) {
        HttpStatus httpStatus = HttpStatus.OK;
    ...
    protected ResponseEntity<GenericResponse<String>> getErrorValidacionResponse(String mensaje) {
        HttpStatus httpStatus = HttpStatus.OK;
        GenericResponse<String> genericResponse = new GenericResponse<>();
