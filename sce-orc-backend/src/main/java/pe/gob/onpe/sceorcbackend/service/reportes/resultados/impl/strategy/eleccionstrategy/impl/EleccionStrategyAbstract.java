...
import pe.gob.onpe.sceorcbackend.model.dto.reporte.ResumenActasContabilizadas;
...
public abstract class EleccionStrategyAbstract implements EleccionStrategy {
    ...
    /**
     * Añade información de ubicación al mapa de parámetros
     */
    protected void agregarParametrosUbicacion(Map<String, Object> parametros, Map<String, Object> datos) {
        if(datos.get("c_codigo_ambito_electoral") == null || datos.get("c_nombre_ambito_electoral") == null) {
            parametros.put("odpe", "");
        } else {
            parametros.put("odpe", datos.get("c_codigo_ambito_electoral").toString() + " - " + datos.get("c_nombre_ambito_electoral").toString());
        }
        if(datos.get("c_codigo_centro_computo") == null || datos.get("c_nombre_centro_computo") == null) {
            parametros.put("ccomputo", "");
        } else {
            parametros.put("ccomputo", datos.get("c_codigo_centro_computo").toString() + " - " + datos.get("c_nombre_centro_computo").toString());
        }
    }
