...
public class ErroresActaWrapper {
  ...
  private List<DetActa> detActaListToErrores;
  private List<DetActaPreferencial> detActaPreferencialListToErrores;
  private List<DetActaOpcion> detActaOpcionListToErrores;
}
