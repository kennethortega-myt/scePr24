...
public class  MiembroMesaCola implements Serializable {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generator_tab_miembro_mesa_cola_pk")
	@SequenceGenerator(name = "generator_tab_miembro_mesa_cola_pk", sequenceName = "seq_tab_miembro_mesa_cola_pk", allocationSize = 1)
	private Long id;
