...
public class EleccionSenadoresStrategyImpl extends PreferencialEleccionStrategyAbstract {
    ...
    public EleccionSenadoresStrategyImpl(UtilSceService utilSceService, IUbiEleccionAgrupolRepositoryCustom ubiEleccionAgrupolRepositoryCustom, TipoReporteStrategyFactory resultadosTipoReporteStrategyFactory) {
    ...
    private void setVotosPreferenciales(ReporteResultadoActasContDto.ReporteResultadoActasContDtoBuilder builder, Map<String, Object> resultado) {
        try {
            ...
            System.err.println("Error al asignar votos preferenciales: " + e.getMessage());
        }
    }
}