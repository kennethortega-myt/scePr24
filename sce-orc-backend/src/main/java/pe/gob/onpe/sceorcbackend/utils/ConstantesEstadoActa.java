...
public class ConstantesEstadoActa {
    ...
    public static final String ESTADO_DIGTAL_TEMP_SCESCANNER_NO_INSTA_EXTRA_SINIE = "Z";
    ...
    public static final Set<String> ESTADOS_ACTA_NO_PROCESADOS = Set.of(
    ...
    private static final Map<String, String> MAP_ESTADO_ACTAS = new HashMap<>();

    //temporalmente, se quitara este map para usar el map de catalogo
    static {
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_PENDIENTE, "pendiente");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_PRIMER_CONTROL, "primer control");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_DIGITALIZADA, "digitada");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_PROCESADA, "procesada");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_SEGUNDA_VERIFICACION, "digita con error");//segunda digitacion
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_DIGITACIONES_POR_VERIFICAR, "digitaciones por verificar");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_PARA_ENVIO_AL_JURADO, "observada");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_ENVIADA_A_JEE, "enviada al jee");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_ASOCIADA_A_RESOLUCION, "sin_aplicar");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_ACTA_DEVUELTA, "devuelta");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_PROCESADA_POR_RESOLUCION, "aplicada");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_EXTRAVIADA, "extraviada");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_SINIESTRADA, "siniestrada");
        MAP_ESTADO_ACTAS.put(ESTADO_ACTA_MESA_NO_INSTALADA, "mesa no instalada");
    }

    public static Map<String, String> getMapEstadoActas() {
        return MAP_ESTADO_ACTAS;
    }
