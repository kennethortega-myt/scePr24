...
@Log4j2
@Repository
public class ReporteOmisosElectoresRepository extends ReporteOmisosRepository {

    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public ReporteOmisosElectoresRepository(JdbcTemplate jdbcTemplate) {
    	super(TipoReporteOmiso.ELECTORES);
