...
@RestController
@RequestMapping("importacion-autorizacion")
public class AutorizacionImportacionController {

	Logger logger = LoggerFactory.getLogger(AutorizacionImportacionController.class);
	
	private final TokenUtilService tokenUtilService;
	
	private final AutorizacionCargaService autorizacionImportacionService;

	public AutorizacionImportacionController(
    ...
    public ResponseEntity<GenericResponse<AutorizacionNacionResponseDto>> consultaAutorizacionNacion(
        ...
        String tipoAutorizacion = ConstantesAutorizacion.TIPO_AUTORIZACION_IMPORTACION_DATOS;
