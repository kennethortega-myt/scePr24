...
public class Version implements Serializable {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generator_tab_version")
	@SequenceGenerator(name = "generator_tab_version", sequenceName = "seq_tab_version_pk", allocationSize = 1)
